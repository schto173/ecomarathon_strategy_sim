...
class Vehicle:
    ...
    corner_loss: float = 0.10           # cornering (slip-induced) drag coefficient; see
    #   vehicle.corner_loss_force. 0 = ignore cornering energy losses; larger = stronger.
...
class Environment:
    ...
    g: float = 9.81             # m/s^2
    wind_speed_kmh: float = 0.0 # steady wind speed (km/h)
    wind_dir_deg: float = 0.0   # compass bearing the wind blows FROM (0=N, 90=E, 180=S, 270=W)
